// Translations for the Employee Sentiment App
const translations = {
  en: {
    // Common
    ...
    // User Survey
    surveyTitle: "Employee Sentiment Survey - Web Version",
    ...
    sentimentAnalysis: "Sentiment Analysis for Open-Ended Questions",
    ...
    noResponses: "No responses yet for this question.",
    responses: "responses",
    
    // Confirmations
    deleteConfirm: "Are you sure you want to delete this question?",
    responseSubmitted: "Responses submitted successfully!",
  ...
  es: {
    ...
    // User Survey
    surveyTitle: "Encuesta de Sentimiento de Empleados - Versión Web",
    ...
    responsesTab: "Respuestas de Usuarios",
    ...
    optionsTitle: "Opciones (máximo 3)",
    option: "Opción",
    ...
    sentimentAnalysis: "Análisis de Sentimiento para Preguntas Abiertas",
    sentimentDistribution: "Distribución de Sentimiento",
    averageSentiment: "Sentimiento Promedio",
    sampleResponses: "Respuestas de Muestra",
    veryPositive: "Muy Positivo",
    positive: "Positivo",
    neutral: "Neutral",
    negative: "Negativo",
    veryNegative: "Muy Negativo",
    noResponses: "Aún no hay respuestas para esta pregunta.",
    responses: "respuestas",
    
    // Confirmations
    deleteConfirm: "¿Estás seguro de que deseas eliminar esta pregunta?",
    responseSubmitted: "¡Respuestas enviadas correctamente!",
